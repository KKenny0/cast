...
写入操作系统临时目录：`<system_temp>/card_whiteboard_{name}.html`
...
```bash
node assets/capture4k.js <system_temp>/card_whiteboard_{name}.html ~/Downloads/{name}.png 1080 800 2 fullpage
```
